...
<body class="g-sidenav-show bg-gray-100">
  ...
  <div class="main-content position-relative bg-gray-100 max-height-vh-100 h-100">
    ...
    <div class="container-fluid">
      <div class="page-header min-height-300 border-radius-xl mt-4" style="background-image: url('../assets/img/curved-images/fondoTut.jpg'); background-position-y: 95%;">
        <span class="mask bg-gradient-primary4 opacity-7"></span>
      </div>
      <div class="card card-body blur shadow-blur mx-4 mt-n6 overflow-hidden">
        <div class="row gx-4">
          <div class="col-auto">
            <div class="avatar avatar-xl position-relative">
              <img src="https://cdn-icons-png.flaticon.com/512/8093/8093141.png" alt="profile_image" class="w-100 border-radius-lg shadow-sm">
            </div>
          </div>
  ...
  <div class="row">
    ...
    <div class="col-md-6">
        ...
        <label for="exampleFormControlInput1">Nombre y denominacion</label>
        <select class="form-selectTut text-uppercase" aria-label="Default select example">
    ...
    <div class="col-md-6">
      ...
      <label for="exampleFormControlInput1"></label>
        <input type="text" class="form-controlTut" id="exampleFormControlInput1" placeholder="Ej. Armando Guzman">
      </div>
    </div>

  </div>

  <button class="btn btn-icon btn-3 btn-primary" type="button" id="btnTut">
