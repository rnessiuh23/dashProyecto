...
<body class="g-sidenav-show bg-gray-100">
  ...
  <div class="row">
    <div class="col-md-6">
      <div class="form-group">
        ...
        <input type="number" class="form-control" id="exampleFormControlInput1" placeholder="1929132">
      </div>
    </div>
    <div class="col-md-6">
      <div class="form-group">
      <label for="exampleFormControlInput1">Nombre completo</label>
        <input type="text" class="form-control text-uppercase" id="exampleFormControlInput1" placeholder="Brian David Peralta Arriaga">
      </div>
    </div>
  </div>
  <div class="row">
  ...
  <div class="col-md-6">
      ...
      <label for="exampleFormControlInput1">Teléfono</label>
        <input type="number" class="form-control" id="exampleFormControlInput1" placeholder="5586092345">
      </div>
    </div>
    <div class="col-md-6">
      <div class="form-group">
  ...
  <div class="col-md-6">
      ...
      <select class="form-select text-uppercase" aria-label="Default select example">
        ...
        <option value="2">AMALIA ÁLVEZ RODRIGUEZ </option>
        <option value="3">LIC. CHRISTIAN DANIEL SALINAS TOLEDANO</option>
        <option value="4">DR EN DIS. JOSUE DENISS ROJAS ARAGON</option>
        <option value="5">FABIAN HERNANDEZ BECIEZ</option>
        <option value="6">DR. RICARDO DE LA ROSA VASQUEZ</option>
    </select>
      </div>
    </div>
    <div class="col-md-6">
